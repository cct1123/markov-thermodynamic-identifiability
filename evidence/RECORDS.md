...
- Date: 2026-09-11 00:48 UTC. The user's subsequent explicit “commit and push” supersedes D020's no-publication instruction for that research run. It authorizes committing the saved E054–E058 proofs, checks, literature comparisons and synthesis, and pushing the resulting history, including the two earlier local commits, to the configured `git@github.com:cct1123/markov-thermodynamic-identifiability.git`, branch `main`. This maintenance request does not reopen scientific investigation or alter PROJECT.md.
